...
export default function PetitFourPage() {
  return (
    <div
      ...
      data-edit-root="vars"
      data-edit-vars="cream,cocoa,pistachio,rose,gilt"
      className={s.page}>
      ...
      <header className={s.bar}>
        <a data-edit="bar.mark" data-edit-max="28" className={s.mark} href="#top">Petit Four</a>
      ...
      <div data-edit-pattern="page.field" data-edit-roles="0,3" className={s.awning} aria-hidden="true">
        <TabbiedPattern
          pattern={picket}
          palette={AWNING}
          fit="grid"
      ...
      <main id="top">
        ...
        <section className={s.front} aria-labelledby="front-h">
          <p data-edit="front.eyebrow" data-edit-max="240" data-edit-multiline className={s.eyebrow}>Patisserie and salon de the, 14 Linden Arcade</p>
          <h1 data-edit="front.title" data-edit-format="emphasis" data-edit-max="70" id="front-h" className={s.title}>
            Petit <em>Four</em>
          </h1>
          ...
          <div className={s.window}>
            <div className={s.wing}>
              <Artwork
                ...
                className={s.wingArt}
              />
              <p data-edit="front.wingLabel" data-edit-max="240" data-edit-multiline className={s.wingLabel}>The cabinet opens</p>
              <p data-edit="front.wingBig" data-edit-max="240" data-edit-multiline className={s.wingBig}>at eight</p>
              <p data-edit="front.wingNote" data-edit-max="240" data-edit-multiline className={s.wingNote}>Tuesday to Saturday, and nine on Sundays. Full by ten.</p>
            </div>
            <div className={s.cartouche}>
              <div data-edit-pattern="front.field" data-edit-roles="0,2,3" className={s.cartoucheField} aria-hidden="true">
                <TabbiedPattern
                  pattern={foldback}
                  palette={CARTOUCHE}
                  fit="grid"
            ...
            <div className={s.wing}>
              <Artwork
                ...
                className={s.wingArt}
              />
              <p data-edit="front.wingLabel2" data-edit-max="240" data-edit-multiline className={s.wingLabel}>A whole gateau needs</p>
              <p data-edit="front.wingBig2" data-edit-max="240" data-edit-multiline className={s.wingBig}>two days</p>
              <p data-edit="front.wingNote2" data-edit-max="240" data-edit-multiline className={s.wingNote}>of notice. A croquembouche needs five, and a good reason.</p>
            </div>
          </div>

          <p data-edit="front.lede" data-edit-max="240" data-edit-multiline className={s.lede}>
        ...
        <section id="cabinet" className={s.sec} aria-labelledby="cabinet-h">
          <div className={s.head}>
            <p data-edit="cabinet.label" data-edit-max="240" data-edit-multiline className={s.label}>La vitrine</p>
            <h2 data-edit="cabinet.title" data-edit-max="60" id="cabinet-h">What is in the cabinet today</h2>
            <div className={s.orn} aria-hidden="true" />
            <p data-edit="cabinet.note" data-edit-max="240" data-edit-multiline className={s.note}>
          ...
          <div className={s.cabinet}>
            <div data-edit-pattern="cabinet.field" data-edit-roles="transparent,2,0" className={s.cabinetBack} aria-hidden="true">
              <TabbiedPattern
                pattern={foldback}
                palette={BACKWALL}
                fit="grid"
            ...
            {SHELVES.map((shelf, i) => (
              <div className={s.shelf} key={shelf.name}>
                <div className={s.shelfHead}>
                  <h3 data-edit={`cabinet.shelfName.${i}`} data-edit-max="40" className={s.shelfName}>{shelf.name}</h3>
                  <p data-edit={`cabinet.shelfWhen.${i}`} data-edit-max="240" data-edit-multiline className={s.shelfWhen}>{shelf.when}</p>
                </div>
                <ul className={s.trays}>
                  {shelf.trays.map((t, i2) => (
                    <li key={t.name} className={s.tray}>
                      <p data-edit={`cabinet.trayName.${i}.${i2}`} data-edit-max="240" data-edit-multiline className={s.trayName}>{t.name}</p>
                      <p data-edit={`cabinet.trayNote.${i}.${i2}`} data-edit-max="240" data-edit-multiline className={s.trayNote}>{t.note}</p>
                      <p data-edit={`cabinet.trayPrice.${i}.${i2}`} data-edit-max="240" data-edit-multiline className={s.trayPrice}>{t.price}</p>
                    </li>
                  ))}
                </ul>
              </div>
          ...
          <p data-edit="cabinet.under" data-edit-max="240" data-edit-multiline className={s.under}>Canneles, madeleines and financiers are sold by the bag at the till.</p>
        </section>
        ...
        <section id="macarons" className={`${s.sec} ${s.macSec}`} aria-labelledby="macarons-h">
          <div className={s.head}>
            ...
            />
            <p data-edit="macarons.label" data-edit-max="240" data-edit-multiline className={s.label}>By the box</p>
            <h2 data-edit="macarons.title" data-edit-max="60" id="macarons-h">Macarons</h2>
            <div className={s.orn} aria-hidden="true" />
            <p data-edit="macarons.note" data-edit-max="240" data-edit-multiline className={s.note}>
          ...
          <ul className={s.macarons}>
            {MACARONS.map((m, i) => (
              <li key={m.name} className={s.macaron}>
                ...
                <span data-edit={`macarons.macName.${i}`} data-edit-max="60" className={s.macName}>{m.name}</span>
              </li>
            ))}
          </ul>
          <dl className={s.boxes}>
            {BOXES.map(([n, what, price], i) => (
              <div key={n} className={s.box}>
                <dt data-edit={`macarons.term.${i}`} data-edit-max="28">{n}</dt>
                <dd data-edit={`macarons.boxWhat.${i}`} data-edit-max="200" data-edit-multiline className={s.boxWhat}>{what}</dd>
                <dd data-edit={`macarons.boxPrice.${i}`} data-edit-max="200" data-edit-multiline className={s.boxPrice}>{price}</dd>
              </div>
            ))}
          </dl>
        </section>
        ...
        <div className={s.ribbonWrap}>
          <div data-edit-pattern="top.field" data-edit-roles="3,0,2" className={s.ribbon} aria-hidden="true">
            <TabbiedPattern
              pattern={foldback}
              palette={RIBBON}
              fit="grid"
          ...
          <p data-edit="top.tag" data-edit-max="240" data-edit-multiline className={s.tag}>Gateaux to order</p>
        </div>
        ...
        <section id="gateaux" className={s.sec} aria-labelledby="gateaux-h">
          <div className={s.gateauHead}>
            ...
            />
            <div className={s.head}>
              <p data-edit="gateaux.label" data-edit-max="240" data-edit-multiline className={s.label}>For a table, a birthday, a Sunday</p>
              <h2 data-edit="gateaux.title" data-edit-max="60" id="gateaux-h">Order a gateau</h2>
              <div className={s.orn} aria-hidden="true" />
            </div>
            <Artwork
          ...
          <div className={s.pair}>
            <div className={s.pairCol}>
              <h3 data-edit="gateaux.colTitle" data-edit-max="40" className={s.colTitle}>Sizes</h3>
              <dl className={s.sizes}>
                {SIZES.map(([size, serves, price], i) => (
                  <div key={size}>
                    <dt data-edit={`gateaux.term.${i}`} data-edit-max="28">{size}</dt>
                    <dd data-edit={`gateaux.serves.${i}`} data-edit-max="200" data-edit-multiline className={s.serves}>{serves}</dd>
                    <dd data-edit={`gateaux.sizePrice.${i}`} data-edit-max="200" data-edit-multiline className={s.sizePrice}>{price}</dd>
                  </div>
                ))}
              </dl>
            </div>
            ...
            <div className={s.pairCol}>
              <h3 data-edit="gateaux.colTitle2" data-edit-max="40" className={s.colTitle}>Flavors</h3>
              <dl className={s.flavors}>
                {GATEAUX.map(([name, what], i) => (
                  <div key={name}>
                    <dt data-edit={`gateaux.term2.${i}`} data-edit-max="28">{name}</dt>
                    <dd data-edit={`gateaux.body.${i}`} data-edit-max="200" data-edit-multiline>{what}</dd>
                  </div>
                ))}
              </dl>
            </div>
          ...
          <ul className={s.notice}>
            {NOTICE.map(([what, time], i) => (
              <li key={what}>
                <span data-edit={`gateaux.noticeWhat.${i}`} data-edit-max="60" className={s.noticeWhat}>{what}</span>
                <span data-edit={`gateaux.noticeTime.${i}`} data-edit-max="60" className={s.noticeTime}>{time}</span>
              </li>
            ))}
          </ul>

          <form className={s.form} action="#">
            <h3 data-edit="gateaux.formTitle" data-edit-max="40" className={s.formTitle}>Ask for a cake</h3>
            <p data-edit="gateaux.formNote" data-edit-max="240" data-edit-multiline className={s.formNote}>Priya answers every request by phone the same day. Nothing is baked until you have spoken.</p>
            <div className={s.formGrid}>
              <div className={s.field}>
                <label data-edit="gateaux.label2" htmlFor="pf-name">Your name</label>
                <input id="pf-name" name="name" type="text" autoComplete="name" />
              </div>
              <div className={s.field}>
                <label data-edit="gateaux.label3" htmlFor="pf-phone">Telephone</label>
                <input id="pf-phone" name="phone" type="tel" autoComplete="tel" />
              </div>
              <div className={s.field}>
                <label data-edit="gateaux.label4" htmlFor="pf-cake">Gateau</label>
              ...
              <div className={s.field}>
                <label data-edit="gateaux.label5" htmlFor="pf-size">Size</label>
              ...
              <div className={s.field}>
                <label data-edit="gateaux.label6" htmlFor="pf-date">Collection day</label>
                <input id="pf-date" name="date" type="date" />
              </div>
              <div className={s.field}>
                <label data-edit="gateaux.label7" htmlFor="pf-plaque">Written on the plaque</label>
                <input id="pf-plaque" name="plaque" type="text" maxLength={30} placeholder="Up to 30 letters" />
              </div>
              <div className={`${s.field} ${s.fieldWide}`}>
                <label data-edit="gateaux.label8" htmlFor="pf-notes">Anything else</label>
                <textarea id="pf-notes" name="notes" rows={3} />
              </div>
            </div>
            <button data-edit="gateaux.submit" data-edit-max="24" className={s.submit} type="submit">Send the request</button>
          </form>
        </section>
        ...
        <section id="salon" className={`${s.sec} ${s.salonSec}`} aria-labelledby="salon-h">
          <div className={s.salon}>
            <div className={s.head}>
              <p data-edit="salon.label" data-edit-max="240" data-edit-multiline className={s.label}>Salon de the</p>
              <h2 data-edit="salon.title" data-edit-max="60" id="salon-h">Six marble tables</h2>
              <div className={s.orn} aria-hidden="true" />
              <p data-edit="salon.note" data-edit-max="240" data-edit-multiline className={s.note}>
            ...
            <div className={s.carte}>
              ...
              />
              <h3 data-edit="salon.carteTitle" data-edit-max="40" className={s.carteTitle}>La carte</h3>
              <ul className={s.carteList}>
                {SALON.map(([item, price], i) => (
                  <li key={item}>
                    <span data-edit={`salon.carteItem.${i}`} data-edit-max="60" className={s.carteItem}>{item}</span>
                    <span data-edit={`salon.cartePrice.${i}`} data-edit-max="60" className={s.cartePrice}>{price}</span>
                  </li>
                ))}
              </ul>
            </div>
            <p data-edit="salon.under" data-edit-max="240" data-edit-multiline className={s.under}>Le gouter is served from 3 to 5 on weekdays. Groups of six or more may book a table.</p>
          </div>
        </section>
        ...
        <section id="kitchen" className={s.sec} aria-labelledby="kitchen-h">
          <div className={s.head}>
            <p data-edit="kitchen.label" data-edit-max="240" data-edit-multiline className={s.label}>Behind the cabinet</p>
            <h2 data-edit="kitchen.title" data-edit-max="60" id="kitchen-h">The kitchen</h2>
            <div className={s.orn} aria-hidden="true" />
          </div>
          <ul className={s.people}>
            {PEOPLE.map((p, i) => (
              <li key={p.name} className={s.person}>
                ...
                <p data-edit={`kitchen.personNote.${i}`} data-edit-max="240" data-edit-multiline className={s.personNote}>{p.note}</p>
              </li>
            ))}
          </ul>
        </section>
        ...
        <section id="questions" className={s.sec} aria-labelledby="questions-h">
          <div className={s.head}>
            <p data-edit="questions.label" data-edit-max="240" data-edit-multiline className={s.label}>Asked at the counter</p>
            <h2 data-edit="questions.title" data-edit-max="60" id="questions-h">Good to know</h2>
            <div className={s.orn} aria-hidden="true" />
          </div>
          <div className={s.faq}>
            {QUESTIONS.map(([q, a], i) => (
        ...
        <section id="visit" className={s.sec} aria-labelledby="visit-h">
          <div className={s.head}>
            <p data-edit="visit.label" data-edit-max="240" data-edit-multiline className={s.label}>Under the arcade clock</p>
            <h2 data-edit="visit.title" data-edit-max="60" id="visit-h">Visit</h2>
            <div className={s.orn} aria-hidden="true" />
          </div>
          <div className={s.pair}>
            <div className={s.pairCol}>
              <h3 data-edit="visit.colTitle" data-edit-max="40" className={s.colTitle}>Hours</h3>
            ...
            <div className={s.pairRule} aria-hidden="true" />
            <div className={s.pairCol}>
              <h3 data-edit="visit.colTitle2" data-edit-max="40" className={s.colTitle}>The shop</h3>
              <p data-edit="visit.body" data-edit-max="240" data-edit-multiline className={s.address}>
                14 Linden Arcade
                <br />
                Wexley Square
              </p>
              <p data-edit="visit.small" data-edit-max="240" data-edit-multiline className={s.small}>Between the florist and the bookbinder, under the clock. Step-free from the square side.</p>
              <p className={s.contact}>
                <a data-edit="visit.link" data-edit-max="28" href="tel:+15550134410">(555) 013-4410</a>
              </p>
              <p className={s.contact}>
                <a data-edit="visit.link2" data-edit-max="28" href="mailto:bonjour@petitfour.example">bonjour@petitfour.example</a>
              </p>
            </div>
          </div>
        </section>
      ...
      <footer className={s.footer}>
        <div data-edit-pattern="footer.field" data-edit-roles="0,3" className={s.footAwning} aria-hidden="true">
          <TabbiedPattern
            pattern={picket}
            palette={AWNING}
            fit="grid"
        ...
        <div className={s.footInner}>
          <p data-edit="footer.footName" data-edit-max="240" data-edit-multiline className={s.footName}>Petit Four</p>
          <p data-edit="footer.body" data-edit-max="240" data-edit-multiline>A fictional French patisserie. Pastries, prices and people are invented.</p>
          <p data-edit="footer.body2" data-edit-max="240" data-edit-multiline>The pastry engravings are generated images, drawn in the page's own colors.</p>
          <p>
            Patterns by{' '}
