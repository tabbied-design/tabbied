    ...
    <div className={s.page}>
      ...
      <header className={s.bar}>
        <a className={s.brand} href="#top">
          ...
          <span className={s.brandName}>Crux</span>
          <span className={s.brandSub}>Climbing</span>
        </a>
        ...
        <a className={s.barCta} href="#first-visit">First visit</a>
      ...
      <main id="top">
        ...
        <section className={s.hero} aria-labelledby="hero-h">
          <div className={s.heroText}>
            <p className={s.kicker}>Bouldering and ropes, 40 Quarry Road</p>
            ...
            <div className={s.heroActions}>
              <a className={s.btn} href="#first-visit">Plan a first visit</a>
              <a className={s.btnGhost} href="#grades">See the grade chart</a>
            </div>
          ...
          <div className={s.wall}>
            ...
            <p className={s.wallTag}>
              ...
              <span>Blue tag, V3. The Cave, problem 12.</span>
            </p>
          </div>
        </section>
        ...
        <section id="grades" className={s.grades} aria-labelledby="grades-h">
          <div className={s.secHead}>
            <p className={s.eyebrow}>The grade chart</p>
            <h2 id="grades-h">What is on the walls this week</h2>
          ...
          <div className={s.charts}>
            <figure className={s.chart}>
              <figcaption className={s.chartHead}>
                ...
                <span>214 problems, V-scale</span>
              </figcaption>
              <ol className={s.bars}>
                {BOULDERS.map((b) => (
                  <li key={b.grade} className={s.barCol} data-tag={b.tag} style={{ '--n': b.count } as React.CSSProperties}>
                    ...
                    <span className={s.barGrade}>{b.grade}</span>
            ...
            <figure className={s.chart}>
              <figcaption className={s.chartHead}>
                <strong>Ropes</strong>
                <span>96 routes, 12-15 m, Yosemite scale</span>
              </figcaption>
              <ol className={s.bars}>
                {ROPES.map((r) => (
                  <li key={r.grade} className={s.barCol} data-tag={r.tag} style={{ '--n': r.count } as React.CSSProperties}>
                    ...
                    <span className={s.barStack} aria-hidden="true" />
                    <span className={s.barTag} aria-hidden="true" />
                    <span className={s.barGrade}>{r.grade}</span>
          ...
          <div className={s.newSet}>
            <h3>Newly set</h3>
            <ul>
              {NEW_SET.map(([wall, what, when]) => (
                <li key={wall}>
                  <strong>{wall}</strong>
                  <span className={s.newWhat}>{what}</span>
                  <span className={s.newWhen}>{when}</span>
                </li>
              ))}
            </ul>
          </div>
        ...
        <section id="first-visit" className={s.visit} aria-labelledby="visit-h">
          <div className={s.visitInner}>
            <div className={s.visitIntro}>
              ...
              <h2 id="visit-h">Five moves to the top</h2>
              <p>
              ...
              <a className={s.btnDark} href="mailto:desk@cruxclimbing.example">Book an induction</a>
              <Artwork
        ...
        <section id="prices" className={s.prices} aria-labelledby="prices-h">
          <div className={s.secHead}>
            <p className={s.eyebrow}>Memberships and day passes</p>
            <h2 id="prices-h">Climb once, or climb all year</h2>
            <p className={s.secNote}>
          ...
          <div className={s.rentals}>
            ...
            <div className={s.rentalBody}>
              <h3>Rentals and lessons</h3>
              <dl className={s.rentalList}>
                {RENTALS.map(([what, price]) => (
                  <div key={what}>
                    <dt>{what}</dt>
                    <dd>{price}</dd>
                  </div>
        ...
        <section id="youth" className={s.youth} aria-labelledby="youth-h">
          <div className={s.secHead}>
            <p className={s.eyebrow}>Youth club</p>
            <h2 id="youth-h">For climbers under eighteen</h2>
            <p className={s.secNote}>
          ...
          <ul className={s.youthGrid}>
            {YOUTH.map((y) => (
              <li key={y.name} className={s.youthCard}>
                <span className={s.youthAges}>{y.ages}</span>
                <h3>{y.name}</h3>
                <p className={s.youthText}>{y.text}</p>
                <p className={s.youthWhen}>{y.when}</p>
                <strong className={s.youthPrice}>{y.price}</strong>
              </li>
            ))}
          </ul>
        </section>
        ...
        <section id="hours" className={s.hours} aria-labelledby="hours-h">
          <div className={s.hoursInner}>
            <div>
              <p className={s.eyebrowLight}>Hours and finding us</p>
              <h2 id="hours-h">Open early, open late</h2>
            ...
            <div className={s.findUs}>
              <h3>40 Quarry Road</h3>
              <p>In the old brick depot behind the bus garage. Free parking for 60 cars and covered bike racks by the door.</p>
              <a className={s.findLink} href="tel:+15550132870">(555) 013-2870</a>
              <a className={s.findLink} href="mailto:desk@cruxclimbing.example">desk@cruxclimbing.example</a>
              <div className={s.faq}>
                {FAQS.map((f) => (
      ...
      <footer className={s.footer}>
        <div className={s.footInner}>
          <p className={s.footName}>Crux</p>
          <p className={s.footTag}>Bouldering and rope climbing, 40 Quarry Road.</p>
        ...
        <div className={s.footFine}>
          <p>A fictional climbing gym. Grades, counts, prices and people are invented.</p>
          <p>
