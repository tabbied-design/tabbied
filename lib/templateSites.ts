import {
  ...
  nutation, elbow, chain, kern, parity, foldback, ivy, gimbal, rafter, dotfade,
  hourglass, streaking, percale, shading, maze, diadem, ripplering, corduroy, waterbomb, neon,
  bowl, roundpair, mullion, guernsey, radius, evolute, bangle, isometry, roundstep, dimmer,
  drypoint, ortho, picket, mixtape, fluting, rimband, scramble, flux, roundcut, drybrush,
  octagon, tetro, casing, cove, cavetto, dotmatrix, scumble, quilt, bothcut, buttonhole,
...
export const NEW_TEMPLATE_SITES: NewTemplateSite[] = [
  ...
  // 2026-09-26: fifty small-business sites (seed prefix sb-), each on a
  // design no earlier template leads with.
  { slug: 'rye-and-levain', name: 'Rye & Levain', topic: 'Sourdough bakery and mill', patternSlug: 'nutation', pattern: nutation, paletteName: 'Flour and rye', palette: ['#F5F3EE', '#1C1B19', '#7A5230', '#F0B43C'], seed: 'sb-ra' },
  { slug: 'arc-orthodontics', name: 'Arc Orthodontics', topic: 'Orthodontist', patternSlug: 'elbow', pattern: elbow, paletteName: 'Electric violet', palette: ['#FCFBFF', '#17152E', '#5B3CF5', '#FF8FB1'], seed: 'sb-ao' },
  { slug: 'muddy-paws-mobile', name: 'Muddy Paws', topic: 'Mobile dog grooming', patternSlug: 'chain', pattern: chain, paletteName: 'Suds and sunshine', palette: ['#FFF6E5', '#2E1F16', '#0F8A80', '#FFC83D', '#F2735A'], seed: 'sb-mp' },
  { slug: 'rind-and-curd', name: 'Rind & Curd', topic: 'Cheese shop', patternSlug: 'kern', pattern: kern, paletteName: 'Wax and paste', palette: ['#F6F0E3', '#221C17', '#A8322A', '#E8C35A', '#56697A'], seed: 'sb-rin' },
  { slug: 'southpaw-boxing', name: 'Southpaw Boxing Club', topic: 'Boxing gym', patternSlug: 'parity', pattern: parity, paletteName: 'Fight poster', palette: ['#EFE6D2', '#151311', '#C8231B', '#BFA57A'], seed: 'sb-sb' },
  { slug: 'petit-four', name: 'Petit Four', topic: 'French patisserie', patternSlug: 'foldback', pattern: foldback, paletteName: 'Pistachio and rose', palette: ['#FBF6EE', '#3A2327', '#BCD4A0', '#F0BCC6', '#A57A42'], seed: 'sb-pf' },
  { slug: 'gentle-dental', name: 'Gentle Dental Studio', topic: 'Dentist for nervous patients', patternSlug: 'ivy', pattern: ivy, paletteName: 'Sage and linen', palette: ['#F4F1E8', '#26352C', '#A7BBA1', '#5A7A62', '#D9B7A0'], seed: 'sb-gd' },
  { slug: 'velvet-cat-grooming', name: 'Velvet', topic: 'Cat grooming salon', patternSlug: 'gimbal', pattern: gimbal, paletteName: 'Dusty plum velvet', palette: ['#3A2533', '#F3E9E1', '#B58CA2', '#E3C7C8'], seed: 'sb-vc' },
  { slug: 'ridgecap-roofing', name: 'Ridgecap Roofing', topic: 'Roofing contractor', patternSlug: 'rafter', pattern: rafter, paletteName: 'Blueprint and safety orange', palette: ['#F3F5F7', '#14284A', '#F26419', '#8FB3DC'], seed: 'sb-rr' },
  { slug: 'panel-break-comics', name: 'Panel Break Comics', topic: 'Comic book shop', patternSlug: 'dotfade', pattern: dotfade, paletteName: 'Four-color newsprint', palette: ['#FBF3DC', '#16130F', '#E33B2E', '#FFD23A', '#2B6FD8'], seed: 'sb-pb' },
  { slug: 'blue-plate-diner', name: 'The Blue Plate', topic: 'All-day diner', patternSlug: 'hourglass', pattern: hourglass, paletteName: 'Cherry and chrome', palette: ['#F7EFDC', '#1B2A4A', '#C62F36', '#2F5DA8'], seed: 'sb-bp' },
  { slug: 'meridian-acupuncture', name: 'Meridian Acupuncture', topic: 'Acupuncture clinic', patternSlug: 'streaking', pattern: streaking, paletteName: 'Ink and seal', palette: ['#F2EDE3', '#24231F', '#B8392B', '#3F5566'], seed: 'sb-ma' },
  { slug: 'stitch-lane-tailors', name: 'Stitch Lane', topic: 'Tailor and alterations', patternSlug: 'percale', pattern: percale, paletteName: 'Chalk on navy', palette: ['#1D2438', '#F3EDE1', '#F0A3B4', '#E8C15A', '#4A5A86'], seed: 'sb-sl' },
  { slug: 'longform-pilates', name: 'Longform Pilates', topic: 'Reformer Pilates studio', patternSlug: 'shading', pattern: shading, paletteName: 'Stone and oat', palette: ['#EBE6DE', '#2A2521', '#D8CAB3', '#8C6450'], seed: 'sb-lp' },
  { slug: 'the-locked-room', name: 'The Locked Room', topic: 'Escape rooms', patternSlug: 'maze', pattern: maze, paletteName: 'Manila and stamp', palette: ['#E8D6A8', '#221E19', '#B1261F', '#2E4A7A'], seed: 'sb-tl' },
  { slug: 'saffron-house', name: 'Saffron House', topic: 'Indian restaurant', patternSlug: 'diadem', pattern: diadem, paletteName: 'Jewel box plum', palette: ['#2B1030', '#F2A31B', '#0F6D68', '#C7304E', '#F7EAD3'], seed: 'sb-sh' },
  { slug: 'clearsound-hearing', name: 'Clearsound Hearing', topic: 'Hearing clinic', patternSlug: 'ripplering', pattern: ripplering, paletteName: 'Large print navy', palette: ['#FBF6EA', '#14254A', '#FFCF33', '#9CC3E6'], seed: 'sb-ch' },
  { slug: 'last-and-awl', name: 'Last & Awl', topic: 'Shoe and leather repair', patternSlug: 'corduroy', pattern: corduroy, paletteName: 'Enamel sign green', palette: ['#EEE4CF', '#173F2F', '#C8993A', '#6F2320', '#A8672F'], seed: 'sb-la' },
  { slug: 'paper-plane-stationers', name: 'Paper Plane', topic: 'Stationery shop', patternSlug: 'waterbomb', pattern: waterbomb, paletteName: 'Graph paper pastels', palette: ['#FBFAF4', '#23409A', '#A8E0C8', '#F5BCCB', '#F3DF85'], seed: 'sb-pp' },
  { slug: 'starlite-lanes', name: 'Starlite Lanes', topic: 'Bowling alley and bar', patternSlug: 'neon', pattern: neon, paletteName: 'Googie neon night', palette: ['#0D1233', '#FF4FA3', '#3DE0F0', '#FFCF4A', '#8B5CF6'], seed: 'sb-sta' },
  { slug: 'pho-nam', name: 'Pho Nam', topic: 'Vietnamese noodle house', patternSlug: 'bowl', pattern: bowl, paletteName: 'Counter board green', palette: ['#0E3A2C', '#F2E9D4', '#CF3328', '#E6AB3A', '#2A6B50'], seed: 'sb-pn' },
  { slug: 'willow-midwifery', name: 'Willow Midwifery', topic: 'Midwife and doula practice', patternSlug: 'roundpair', pattern: roundpair, paletteName: 'Terracotta linen olive', palette: ['#F5EDE3', '#3A2A22', '#B35A3A', '#E9B8A5', '#66703F'], seed: 'sb-wm' },
  { slug: 'bright-pane-windows', name: 'Bright Pane', topic: 'Window and gutter cleaning', patternSlug: 'mullion', pattern: mullion, paletteName: 'Sky poster blue', palette: ['#FBFCFD', '#0C0E11', '#9CD3F4', '#1D5FD1', '#FFD43B'], seed: 'sb-bri' },
  { slug: 'purl-and-ply', name: 'Purl & Ply', topic: 'Yarn shop and knitting classes', patternSlug: 'guernsey', pattern: guernsey, paletteName: 'Oatmeal rust moss', palette: ['#EFE5D3', '#34281F', '#B4532E', '#5D6A38', '#D8A445'], seed: 'sb-pa' },
  { slug: 'tatami-dojo', name: 'Tatami', topic: 'Karate school', patternSlug: 'radius', pattern: radius, paletteName: 'Bauhaus belt primaries', palette: ['#F6F4EF', '#121212', '#F2B705', '#2B8A57', '#1F4FA3', '#D33A22'], seed: 'sb-td' },
  { slug: 'casa-olivo', name: 'Casa Olivo', topic: 'Tapas bar', patternSlug: 'evolute', pattern: evolute, paletteName: 'Seville tile', palette: ['#F4ECDC', '#1F3C88', '#A9442A', '#C7D3EA', '#1C2233'], seed: 'sb-co' },
  { slug: 'chatterbox-speech', name: 'Chatterbox', topic: "Children's speech therapy", patternSlug: 'bangle', pattern: bangle, paletteName: 'Soft primaries', palette: ['#FDF8EF', '#E8604C', '#F5C243', '#5B9BD9', '#26315C'], seed: 'sb-cs' },
  { slug: 'steady-hands-movers', name: 'Steady Hands Movers', topic: 'Local moving company', patternSlug: 'isometry', pattern: isometry, paletteName: 'Kraft and stencil', palette: ['#D7B98C', '#1E1A15', '#C3362B', '#A5794A', '#2D5A4C'], seed: 'sb-ste' },
  { slug: 'beet-street-grocer', name: 'Beet Street Grocer', topic: 'Greengrocer', patternSlug: 'roundstep', pattern: roundstep, paletteName: 'Market chalkboard', palette: ['#1F2A27', '#ECE8DC', '#B0305A', '#7AA35A', '#E58A3A'], seed: 'sb-bs' },
  { slug: 'easel-evenings', name: 'Easel Evenings', topic: 'Paint-and-sip classes', patternSlug: 'dimmer', pattern: dimmer, paletteName: 'Studio primaries', palette: ['#F5F0E6', '#1C1B2B', '#E2432A', '#2D3FBF', '#F3B11B', '#178A6A'], seed: 'sb-ee' },
  { slug: 'post-oak-smokehouse', name: 'Post Oak Smokehouse', topic: 'Texas barbecue', patternSlug: 'drypoint', pattern: drypoint, paletteName: 'Butcher paper handbill', palette: ['#DCC6A2', '#1B1612', '#9E2418', '#6F5A45'], seed: 'sb-po' },
  { slug: 'solefit-podiatry', name: 'Solefit Podiatry', topic: 'Podiatry clinic', patternSlug: 'ortho', pattern: ortho, paletteName: 'Swiss signal red', palette: ['#F5F4F0', '#141414', '#E2231A'], seed: 'sb-sp' },
  { slug: 'big-yard-dog-daycare', name: 'Big Yard', topic: 'Dog daycare and boarding', patternSlug: 'picket', pattern: picket, paletteName: 'Grass and tennis ball', palette: ['#F3EDDC', '#1F2B1E', '#3E8A3A', '#F07F22'], seed: 'sb-by' },
  { slug: 'second-life-vintage', name: 'Second Life Vintage', topic: 'Vintage clothing store', patternSlug: 'mixtape', pattern: mixtape, paletteName: 'Xerox pink and lime', palette: ['#111111', '#F1EEE4', '#FF2D8A', '#C5F12E'], seed: 'sb-sec' },
  { slug: 'birchwood-sauna', name: 'Birchwood Sauna House', topic: 'Public sauna', patternSlug: 'fluting', pattern: fluting, paletteName: 'Charcoal birch ember', palette: ['#1B1917', '#ECE5D8', '#E0652E', '#8DB6C4'], seed: 'sb-bir' },
  { slug: 'everything-bagels', name: 'Everything Bagel Co.', topic: 'Bagel shop', patternSlug: 'rimband', pattern: rimband, paletteName: 'Deli mustard', palette: ['#FFF4DC', '#15120E', '#F2B227', '#C93A22', '#B86A2D'], seed: 'sb-eb' },
  { slug: 'honor-roll-tutoring', name: 'Honor Roll Tutoring', topic: 'Tutoring center', patternSlug: 'scramble', pattern: scramble, paletteName: 'Notebook and highlighter', palette: ['#FBF9F1', '#23262D', '#2F55A4', '#D6453A', '#F3DC3F'], seed: 'sb-hr' },
  { slug: 'mainspring-repair', name: 'Mainspring', topic: 'Watch and jewelry repair', patternSlug: 'flux', pattern: flux, paletteName: 'Black and gilt', palette: ['#0F0E0C', '#EFE7D4', '#C8A35A', '#A3312C'], seed: 'sb-mr' },
  { slug: 'whisk-and-ladle', name: 'Whisk & Ladle', topic: 'Kitchenware shop and cooking school', patternSlug: 'roundcut', pattern: roundcut, paletteName: 'Atomic enamel', palette: ['#F6ECD6', '#2B2622', '#1F8A84', '#E0662A', '#E8B33A'], seed: 'sb-wa' },
  { slug: 'kettle-and-leaf', name: 'Kettle & Leaf', topic: 'Tea room', patternSlug: 'drybrush', pattern: drybrush, paletteName: 'Moss and rice paper', palette: ['#F3EFE4', '#2C2E28', '#6F7D5C', '#A3AD7E', '#B07A55'], seed: 'sb-ka' },
  { slug: 'zaatar-and-co', name: "Za'atar & Co.", topic: 'Lebanese bakery', patternSlug: 'octagon', pattern: octagon, paletteName: 'Sumac and olive', palette: ['#EFE3C8', '#2A2318', '#58662A', '#A02338', '#C29A3A'], seed: 'sb-za' },
  { slug: 'byte-fix-repair', name: 'Byte Fix', topic: 'Phone and computer repair', patternSlug: 'tetro', pattern: tetro, paletteName: 'Beige box desktop', palette: ['#D4D6D1', '#16181C', '#1F47A8', '#D9432B', '#2E8B57'], seed: 'sb-bf' },
  { slug: 'mitre-and-gilt', name: 'Mitre & Gilt', topic: 'Picture framing', patternSlug: 'casing', pattern: casing, paletteName: 'Gallery wall gilt', palette: ['#E9E4DA', '#1C1A17', '#B08A3E', '#5B3A25', '#2C4A40'], seed: 'sb-mit' },
  { slug: 'sunny-side-cafe', name: 'Sunny Side', topic: 'Breakfast and brunch cafe', patternSlug: 'cove', pattern: cove, paletteName: 'Sunrise diner', palette: ['#F7EAD0', '#4B2913', '#E2692B', '#E7AB32', '#B5471F'], seed: 'sb-ss' },
  { slug: 'posy-wedding-flowers', name: 'Posy', topic: 'Wedding florist', patternSlug: 'cavetto', pattern: cavetto, paletteName: 'Blush and fern', palette: ['#F4E3DC', '#1F3A2C', '#C0616F', '#8FA588', '#E7B8AE'], seed: 'sb-pw' },
  { slug: 'delancey-deli', name: 'Delancey Deli', topic: 'Sandwich deli', patternSlug: 'dotmatrix', pattern: dotmatrix, paletteName: 'Tile and mustard', palette: ['#F6F2E9', '#25221E', '#1F4033', '#C63B2C', '#E0A530'], seed: 'sb-dd' },
  { slug: 'fresh-coat-decorators', name: 'Fresh Coat', topic: 'Painting and decorating', patternSlug: 'scumble', pattern: scumble, paletteName: 'Fan deck paints', palette: ['#F4F1EA', '#202427', '#2D5B87', '#C4633C', '#8FA487', '#DFAE47'], seed: 'sb-fc' },
  { slug: 'hearth-insurance', name: 'Hearth Insurance Agency', topic: 'Insurance agency', patternSlug: 'quilt', pattern: quilt, paletteName: 'Forest and hearth', palette: ['#F5EFE2', '#1F3B2D', '#A8482F', '#D4A246', '#8EA58C'], seed: 'sb-hi' },
  { slug: 'long-table-catering', name: 'Long Table', topic: 'Catering company', patternSlug: 'bothcut', pattern: bothcut, paletteName: 'Candlelit charcoal and gold', palette: ['#171614', '#ECE3D0', '#C29A52', '#6D2430'], seed: 'sb-lt' },
  { slug: 'tack-and-button', name: 'Tack & Button', topic: 'Upholstery workshop', patternSlug: 'buttonhole', pattern: buttonhole, paletteName: 'Velvet swatch book', palette: ['#EFE8DC', '#221C1E', '#6E1F2B', '#1F4A40', '#26305A', '#B98A2E'], seed: 'sb-ta' },
];
