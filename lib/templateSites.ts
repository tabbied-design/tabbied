...
export const NEW_TEMPLATE_SITES: NewTemplateSite[] = [
  ...
  { slug: 'harbor-notary', name: "Harbor Notary", topic: "Mobile notary service", patternSlug: 'apse', pattern: apse, paletteName: "Seal and sage", palette: ["#F7F3E8", "#182A32", "#D8572A", "#DDE6DF", "#8CA39A"], seed: 'local-01' },
  { slug: 'true-north-hvac', name: "True North Heating", topic: "Heating and cooling contractor", patternSlug: 'quoit', pattern: quoit, paletteName: "Heat and frost", palette: ["#F2F5F4", "#102A35", "#E85D3F", "#CDE5E7", "#337C8D"], seed: 'local-02' },
  { slug: 'good-dog-walks', name: "Good Dog Walks", topic: "Dog walking service", patternSlug: 'gyre', pattern: gyre, paletteName: "Leash and meadow", palette: ["#FFF8E8", "#243226", "#F06F3C", "#DCE8B5", "#6B8F3D"], seed: 'local-03' },
  { slug: 'bellows-chimney', name: "Bellows Chimney Co.", topic: "Chimney sweep and repair", patternSlug: 'lunette', pattern: lunette, paletteName: "Hearth and soot", palette: ["#F3EBDD", "#211E1B", "#C44B2B", "#D8C7AE", "#74706A"], seed: 'local-04' },
  { slug: 'keynote-piano', name: "Keynote Piano Care", topic: "Piano tuning and repair", patternSlug: 'ringfield', pattern: ringfield, paletteName: "Ivory and mahogany", palette: ["#F8F5EE", "#191A1D", "#B54735", "#E1D6C4", "#626C78"], seed: 'local-05' },
  { slug: 'ledger-tax', name: "Ledger Tax Studio", topic: "Tax preparation service", patternSlug: 'ogee', pattern: ogee, paletteName: "Ledger green", palette: ["#F5F7F2", "#163029", "#C55A32", "#D8E4D8", "#587D6C"], seed: 'local-06' },
  { slug: 'patch-and-plane', name: "Patch & Plane", topic: "Handyman service", patternSlug: 'sheared', pattern: sheared, paletteName: "Workshop ochre", palette: ["#F4F0E6", "#24251F", "#D9782D", "#DFD9C8", "#6F7A61"], seed: 'local-07' },
  { slug: 'stillwater-massage', name: "Stillwater Massage", topic: "Massage therapy practice", patternSlug: 'terrain', pattern: terrain, paletteName: "Clay and eucalyptus", palette: ["#F6F1E9", "#27312D", "#A95844", "#DCE4D7", "#708476"], seed: 'local-08' },
  { slug: 'steadfast-pest', name: "Steadfast Pest Control", topic: "Residential pest control", patternSlug: 'sparkle', pattern: sparkle, paletteName: "Field and amber", palette: ["#F1F4EC", "#1E3024", "#D68A24", "#DCE6CF", "#55745E"], seed: 'local-09' },
  { slug: 'northline-appliance', name: "Northline Appliance Repair", topic: "Home appliance repair", patternSlug: 'bokeh', pattern: bokeh, paletteName: "Enamel and copper", palette: ["#F4F6F7", "#172631", "#E45135", "#D8E6EA", "#47778A"], seed: 'local-10' },
];
