...
const BY_SLUG: Record<string, TemplateCategory> = {
  ...
  'rye-and-levain': 'Food & drink',
  'arc-orthodontics': 'Health',
  'muddy-paws-mobile': 'Services',
  'rind-and-curd': 'Food & drink',
  'southpaw-boxing': 'Wellness & sport',
  'petit-four': 'Food & drink',
  'gentle-dental': 'Health',
  'velvet-cat-grooming': 'Services',
  'ridgecap-roofing': 'Services',
  'panel-break-comics': 'Shop',
  'blue-plate-diner': 'Food & drink',
  'meridian-acupuncture': 'Health',
  'stitch-lane-tailors': 'Services',
  'longform-pilates': 'Wellness & sport',
  'the-locked-room': 'Culture',
  'saffron-house': 'Food & drink',
  'clearsound-hearing': 'Health',
  'last-and-awl': 'Services',
  'paper-plane-stationers': 'Shop',
  'starlite-lanes': 'Culture',
  'pho-nam': 'Food & drink',
  'willow-midwifery': 'Health',
  'bright-pane-windows': 'Services',
  'purl-and-ply': 'Shop',
  'tatami-dojo': 'Wellness & sport',
  'casa-olivo': 'Food & drink',
  'chatterbox-speech': 'Health',
  'steady-hands-movers': 'Services',
  'beet-street-grocer': 'Shop',
  'easel-evenings': 'Studio',
  'post-oak-smokehouse': 'Food & drink',
  'solefit-podiatry': 'Health',
  'big-yard-dog-daycare': 'Services',
  'second-life-vintage': 'Shop',
  'birchwood-sauna': 'Wellness & sport',
  'everything-bagels': 'Food & drink',
  'honor-roll-tutoring': 'Community',
  'mainspring-repair': 'Services',
  'whisk-and-ladle': 'Shop',
  'kettle-and-leaf': 'Food & drink',
  'zaatar-and-co': 'Food & drink',
  'byte-fix-repair': 'Services',
  'mitre-and-gilt': 'Services',
  'sunny-side-cafe': 'Food & drink',
  'posy-wedding-flowers': 'Shop',
  'delancey-deli': 'Food & drink',
  'fresh-coat-decorators': 'Services',
  'hearth-insurance': 'Services',
  'long-table-catering': 'Food & drink',
  'tack-and-button': 'Services',
};
