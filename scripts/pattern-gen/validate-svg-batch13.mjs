// SVG-export gate for batch 13: every design must export as native SVG with
// *no* caveat (no `svgExport: false`, no `svgExportNote`, no converter
// warning) and with pixel parity to the live render. The lints in
// generate-batch13.mjs only reject CSS known to be unsafe; this runs the
...
//   SLUGS=bight,tulle node scripts/pattern-gen/validate-svg-batch13.mjs
//
